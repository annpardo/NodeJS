...
// ================== 端口设置 ==================
process.env.TUIC_PORT = process.env.TUIC_PORT || "";
process.env.HY2_PORT = process.env.HY2_PORT || "";
process.env.REALITY_PORT = process.env.REALITY_PORT || "41579";
process.env.ARGO_PORT = process.env.ARGO_PORT || "8080";
process.env.ARGO_DOMAIN = process.env.ARGO_DOMAIN || "";
process.env.ARGO_TOKEN = process.env.ARGO_TOKEN || "";
process.env.ARGO_ENABLE = process.env.ARGO_ENABLE || "true";
process.env.REALITY_SNI = process.env.REALITY_SNI || "www.nazhumi.com";
process.env.CF_PREFERRED_DOMAIN = process.env.CF_PREFERRED_DOMAIN || process.env.PREFERRED_DOMAIN || "";
process.env.CF_PREFERRED_PORT = process.env.CF_PREFERRED_PORT || process.env.PREFERRED_PORT || "443";
process.env.CHAT_ID = process.env.CHAT_ID || "";
